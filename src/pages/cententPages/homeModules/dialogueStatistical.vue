  ...
  methods:{
    ...
    wechatListValFun:function(obj={
      ...
      getIticket(function(ticket){
        this_.$axios.get(
          "http://"+api+"/api/1.0/statistic/page/message"+'?pageNum='+obj.pageNum+'&pageSize='+obj.pageSize+'&sellerName='+obj.sellerName +'&maxConversationTime='+obj.maxConversationTime+'&minConversationTime='+obj.minConversationTime+'&groupBySeller=true',
          {headers:{
